const ICON_MAP = (name, tempFrame, Fill, tempBorders) => {
  ...
  // android 底部tab 是由线组成的，拿border作背景色
  if (name == 'and-icon-home' || name == 'and-icon-back' || name == 'and-icon-recent') {
    ICON_COLOR = { ...ICON_COLOR, tc: tempBorders.bc }
  }

  let DEFAULT_CONFIG = { is: iconSize(), ...tempFrame, ...tempIcon, z: 10000 }
