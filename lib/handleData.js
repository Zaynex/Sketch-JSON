...
function handleData(node, level, x, y, i) {
  ...
  if (
    ...
    //     return Object.assign({name: 'hr'}, tempFrame, { top: top - 7, height: 10, bc: bc, bs: 0})
    //   }
    //   return Object.assign({name: 've'}, { bc: bc, bs: 0, width: 10, left: left, height: height - 1, top: top - 4})
    // }
